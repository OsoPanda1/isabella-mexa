...
export const GlobalFooter: React.FC = () => {
  ...
  return (
    <footer className="mt-auto border-t border-slate-800 bg-[#030712]/95 text-slate-400 text-xs font-mono backdrop-blur-xl z-40 transition-all duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5 flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-slate-400">CROWN v4.2 Orchestrator</span>
        </div>
